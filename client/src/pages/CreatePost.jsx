      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className=" text-white bg-[#FF647B] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-[#FF647B] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
